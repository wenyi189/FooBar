...
public class solar_doomsday {
    public static int[] answer(int area) {
        ...
        while(dupArea > 0) {
            int temp = (int) Math.sqrt(dupArea);
            int temp2 = temp * temp;
            dupArea = dupArea - temp2;
            result.add(temp2);
        }
    ...
    public static void main(String[] args) {
        solar_doomsday solar = new solar_doomsday();
        int[] solarArray = solar.answer(999);
        for (int i = 0; i <solarArray.length ; i++) {
            System.out.print(solarArray[i] + ", ");
        }
    }
}
